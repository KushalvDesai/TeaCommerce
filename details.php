...
<a class="left carousel-control" data-slide="prev"><!-- left carousel-control Starts -->

</a><!-- left carousel-control Ends -->

<a class="right carousel-control" data-slide="next"><!-- right carousel-control Starts -->
...
<a class='label sale' href='#' style='color:black;'>
  <div class='thelabel' style='padding: 12px 10px;'><?php echo $pro_label?></div>
  <div class='label-background' style='width: 120px; height: 40px;'></div>
</a>
